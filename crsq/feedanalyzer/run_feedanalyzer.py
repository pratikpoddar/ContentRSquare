...
def fa():
	...
	feedextractor.load_rss_in_table("http://feeds.reuters.com/reuters/INtopNews")
	feedextractor.load_rss_in_table("http://feeds.reuters.com/news/artsculture")
	feedextractor.load_rss_in_table("http://feeds.reuters.com/reuters/businessNews")
	feedextractor.load_rss_in_table("http://feeds.reuters.com/reuters/companyNews")
	feedextractor.load_rss_in_table("http://feeds.reuters.com/reuters/entertainment")
	feedextractor.load_rss_in_table("http://feeds.reuters.com/reuters/environment")
	feedextractor.load_rss_in_table("http://feeds.reuters.com/reuters/lifestyle")
	feedextractor.load_rss_in_table("http://feeds.reuters.com/news/reutersmedia")
	feedextractor.load_rss_in_table("http://feeds.reuters.com/news/wealth")
	feedextractor.load_rss_in_table("http://feeds.reuters.com/reuters/MostRead")
	feedextractor.load_rss_in_table("http://feeds.reuters.com/Reuters/PoliticsNews")
	feedextractor.load_rss_in_table("http://feeds.reuters.com/reuters/sportsNews")
	feedextractor.load_rss_in_table("http://feeds.reuters.com/reuters/technologyNews")
	feedextractor.load_rss_in_table("http://feeds.reuters.com/reuters/topNews")
	feedextractor.load_rss_in_table("http://feeds.reuters.com/Reuters/domesticNews")
	feedextractor.load_rss_in_table("http://feeds.reuters.com/Reuters/worldNews")
	feedextractor.load_rss_in_table("http://feeds.reuters.com/news/deals")
