...
def fa():
	...
	feedextractor.load_rss_in_table("http://www.npr.org/rss/rss.php?id=1006")
	feedextractor.load_rss_in_table("http://www.npr.org/rss/rss.php?id=1004")
	feedextractor.load_rss_in_table("http://www.npr.org/rss/rss.php?id=1014")
	feedextractor.load_rss_in_table("http://www.npr.org/rss/rss.php?id=1021")
	feedextractor.load_rss_in_table("http://www.npr.org/rss/rss.php?id=1008")
	feedextractor.load_rss_in_table("http://rss1.smashingmagazine.com/feed/")
	feedextractor.load_rss_in_table("http://feeds.wired.com/GearFactor")
	feedextractor.load_rss_in_table("http://feeds.boingboing.net/boingboing/iBag")
	feedextractor.load_rss_in_table("http://www.ducttapemarketing.com/blog/feed/")
	feedextractor.load_rss_in_table("http://www.engadget.com/rss.xml")
	feedextractor.load_rss_in_table("http://www.tmz.com/rss.xml")
	feedextractor.load_rss_in_table("http://feeds.feedburner.com/fastcompany")
	feedextractor.load_rss_in_table("http://feeds.huffingtonpost.com/huffingtonpost/raw_feed")
