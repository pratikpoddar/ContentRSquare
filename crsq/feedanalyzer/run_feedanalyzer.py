...
def fa():
	...
	feedextractor.load_rss_in_table("http://www.npr.org/rss/rss.php?id=1006", "fromscratch")
	feedextractor.load_rss_in_table("http://www.npr.org/rss/rss.php?id=1004", "fromscratch")
	feedextractor.load_rss_in_table("http://www.npr.org/rss/rss.php?id=1014", "fromscratch")
	feedextractor.load_rss_in_table("http://www.npr.org/rss/rss.php?id=1008", "fromscratch")
	...
	feedextractor.load_rss_in_table("http://feeds.washingtonpost.com/rss/business", "fromscratch")
	feedextractor.load_rss_in_table("http://feeds.washingtonpost.com/rss/world", "fromscratch")
	feedextractor.load_rss_in_table("http://www.washingtonpost.com/wp-dyn/rss/business/government/index.xml", "fromscratch")
	feedextractor.load_rss_in_table("http://www.washingtonpost.com/wp-dyn/rss/business/economy/index.xml", "fromscratch")
	feedextractor.load_rss_in_table("http://www.washingtonpost.com/wp-dyn/rss/business/special/3/index.xml", "fromscratch")
	feedextractor.load_rss_in_table("http://www.washingtonpost.com/wp-dyn/rss/business/personalfinance/index.xml", "fromscratch")
	feedextractor.load_rss_in_table("http://www.washingtonpost.com/wp-dyn/rss/business/special/1/index.xml", "fromscratch")
