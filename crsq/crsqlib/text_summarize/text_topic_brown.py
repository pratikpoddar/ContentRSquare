...
try:
	...
	data_train = fetch_20newsgroups(subset='train', categories=['rec.sport.baseball'],
                                shuffle=True, random_state=42,
                                remove=())

	data_train.data = []
	data_train.target_names = brown.categories()
	data_train.target = []
	...
	for doc in documents:
		data_train.data += [' '.join(doc[0])]
		data_train.target += [data_train.target_names.index(doc[1])]
