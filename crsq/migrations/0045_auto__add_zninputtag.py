...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ZnInputTag'
        db.create_table(u'crsq_zninputtag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.CharField')(max_length=255L)),
            ('heading', self.gf('django.db.models.fields.CharField')(max_length=255L)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'crsq', ['ZnInputTag'])


    def backwards(self, orm):
        # Deleting model 'ZnInputTag'
        db.delete_table(u'crsq_zninputtag')
