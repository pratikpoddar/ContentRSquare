...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailInfo.emailccto'
        db.alter_column(u'crsq_emailinfo', 'emailccto', self.gf('django.db.models.fields.CharField')(max_length=1000L, null=True))

        # Changing field 'EmailInfo.emailto'
        db.alter_column(u'crsq_emailinfo', 'emailto', self.gf('django.db.models.fields.CharField')(max_length=1000L, null=True))

        # Changing field 'EmailInfo.emailbccto'
        db.alter_column(u'crsq_emailinfo', 'emailbccto', self.gf('django.db.models.fields.CharField')(max_length=1000L, null=True))

    def backwards(self, orm):

        # Changing field 'EmailInfo.emailccto'
        db.alter_column(u'crsq_emailinfo', 'emailccto', self.gf('django.db.models.fields.CharField')(max_length=255L, null=True))

        # Changing field 'EmailInfo.emailto'
        db.alter_column(u'crsq_emailinfo', 'emailto', self.gf('django.db.models.fields.CharField')(max_length=255L, null=True))

        # Changing field 'EmailInfo.emailbccto'
        db.alter_column(u'crsq_emailinfo', 'emailbccto', self.gf('django.db.models.fields.CharField')(max_length=255L, null=True))
    ...
    models = {
        ...
        u'crsq.emailinfo': {
            ...
            'places': ('django.db.models.fields.TextField', [], {}),
