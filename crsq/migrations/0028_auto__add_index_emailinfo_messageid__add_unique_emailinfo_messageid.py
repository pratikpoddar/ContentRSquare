...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'EmailInfo', fields ['messageid']
        db.create_index(u'crsq_emailinfo', ['messageid'])

        # Adding unique constraint on 'EmailInfo', fields ['messageid']
        db.create_unique(u'crsq_emailinfo', ['messageid'])


    def backwards(self, orm):
        # Removing unique constraint on 'EmailInfo', fields ['messageid']
        db.delete_unique(u'crsq_emailinfo', ['messageid'])

        # Removing index on 'EmailInfo', fields ['messageid']
        db.delete_index(u'crsq_emailinfo', ['messageid'])
