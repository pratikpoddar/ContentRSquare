...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'EmailLinks', fields ['emailhash', 'link']
        db.create_unique(u'crsq_emaillinks', ['emailhash', 'link'])


    def backwards(self, orm):
        # Removing unique constraint on 'EmailLinks', fields ['emailhash', 'link']
        db.delete_unique(u'crsq_emaillinks', ['emailhash', 'link'])
