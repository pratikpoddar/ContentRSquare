...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArticleSemantics'
        db.create_table(u'crsq_articlesemantics', (
            ...
            ('topic', self.gf('django.db.models.fields.CharField')(max_length=1000L)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'crsq', ['ArticleSemantics'])


    def backwards(self, orm):
        # Deleting model 'ArticleSemantics'
        db.delete_table(u'crsq_articlesemantics')
    ...
    models = {
        ...
        u'crsq.articlesemantics': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'topic': ('django.db.models.fields.CharField', [], {'max_length': '1000L'}),
            'url': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255L', 'db_index': 'True'})
        },
