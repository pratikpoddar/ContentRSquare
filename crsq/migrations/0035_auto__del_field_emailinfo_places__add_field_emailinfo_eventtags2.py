...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EmailInfo.eventtags2'
        db.add_column(u'crsq_emailinfo', 'eventtags2',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EmailInfo.eventtags2'
        db.delete_column(u'crsq_emailinfo', 'eventtags2')
