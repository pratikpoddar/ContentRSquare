...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleInfo.contentlength'
        db.add_column(u'crsq_articleinfo', 'contentlength',
                      self.gf('django.db.models.fields.BigIntegerField')(default=None, db_index=True),
                      keep_default=False)

        # Adding field 'ArticleInfo.contenthash'
        db.add_column(u'crsq_articleinfo', 'contenthash',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255L, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleInfo.contentlength'
        db.delete_column(u'crsq_articleinfo', 'contentlength')

        # Deleting field 'ArticleInfo.contenthash'
        db.delete_column(u'crsq_articleinfo', 'contenthash')
