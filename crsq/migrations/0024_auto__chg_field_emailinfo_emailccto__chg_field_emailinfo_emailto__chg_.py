...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EmailInfo.emailccto'
        db.alter_column(u'crsq_emailinfo', 'emailccto', self.gf('django.db.models.fields.CharField')(max_length=255L))

        # Changing field 'EmailInfo.emailto'
        db.alter_column(u'crsq_emailinfo', 'emailto', self.gf('django.db.models.fields.CharField')(default=None, max_length=255L))

        # Changing field 'EmailInfo.emailbccto'
        db.alter_column(u'crsq_emailinfo', 'emailbccto', self.gf('django.db.models.fields.CharField')(max_length=255L))
