...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArticleInfo.title'
        db.alter_column(u'crsq_articleinfo', 'title', self.gf('django.db.models.fields.CharField')(max_length=100L))

    def backwards(self, orm):

        # Changing field 'ArticleInfo.title'
        db.alter_column(u'crsq_articleinfo', 'title', self.gf('django.db.models.fields.TextField')(max_length=100L))
    ...
    models = {
        ...
        u'crsq.articleinfo': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100L', 'db_index': 'True'}),
