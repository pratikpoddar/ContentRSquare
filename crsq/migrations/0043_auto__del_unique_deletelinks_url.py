...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DeleteLinks', fields ['url']
        db.delete_unique(u'crsq_deletelinks', ['url'])


    def backwards(self, orm):
        # Adding unique constraint on 'DeleteLinks', fields ['url']
        db.create_unique(u'crsq_deletelinks', ['url'])
