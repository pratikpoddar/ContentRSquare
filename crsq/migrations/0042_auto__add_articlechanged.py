...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArticleChanged'
        db.create_table(u'crsq_articlechanged', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=255L, db_index=True)),
        ))
        db.send_create_signal(u'crsq', ['ArticleChanged'])


    def backwards(self, orm):
        # Deleting model 'ArticleChanged'
        db.delete_table(u'crsq_articlechanged')
