...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailInfo'
        db.create_table(u'crsq_emailinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.CharField')(max_length=255L)),
            ('emailfrom', self.gf('django.db.models.fields.CharField')(max_length=255L)),
            ('emailto', self.gf('django.db.models.fields.CharField')(default=None, max_length=255L)),
            ('emailcc', self.gf('django.db.models.fields.CharField')(default=None, max_length=255L)),
            ('emailbcc', self.gf('django.db.models.fields.CharField')(default=None, max_length=255L)),
            ('subject', self.gf('django.db.models.fields.CharField')(default='', max_length=1000L)),
            ('emailtime', self.gf('django.db.models.fields.DateTimeField')()),
            ('cleanbody', self.gf('django.db.models.fields.TextField')()),
            ('shortbody', self.gf('django.db.models.fields.TextField')()),
            ('emailhash', self.gf('django.db.models.fields.CharField')(max_length=255L, db_index=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'crsq', ['EmailInfo'])


    def backwards(self, orm):
        # Deleting model 'EmailInfo'
        db.delete_table(u'crsq_emailinfo')
    ...
    models = {
        ...
        u'crsq.emailinfo': {
            'Meta': {'object_name': 'EmailInfo'},
            'cleanbody': ('django.db.models.fields.TextField', [], {}),
            'emailbcc': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255L'}),
            'emailcc': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255L'}),
            ...
            'emailto': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255L'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
