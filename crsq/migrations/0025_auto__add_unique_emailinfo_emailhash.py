...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'EmailInfo', fields ['emailhash']
        db.create_unique(u'crsq_emailinfo', ['emailhash'])


    def backwards(self, orm):
        # Removing unique constraint on 'EmailInfo', fields ['emailhash']
        db.delete_unique(u'crsq_emailinfo', ['emailhash'])
