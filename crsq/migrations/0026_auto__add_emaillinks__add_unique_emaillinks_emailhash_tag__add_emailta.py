...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailLinks'
        db.create_table(u'crsq_emaillinks', (
        ...
        db.send_create_signal(u'crsq', ['EmailLinks'])

        # Adding unique constraint on 'EmailLinks', fields ['emailhash', 'tag']
        db.create_unique(u'crsq_emaillinks', ['emailhash', 'tag'])

        # Adding model 'EmailTags'
        db.create_table(u'crsq_emailtags', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('emailhash', self.gf('django.db.models.fields.CharField')(max_length=255L, db_index=True)),
            ('tag', self.gf('django.db.models.fields.CharField')(max_length=255L, db_index=True)),
        ))
        db.send_create_signal(u'crsq', ['EmailTags'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EmailLinks'
        db.delete_table(u'crsq_emaillinks')

        # Deleting model 'EmailTags'
        db.delete_table(u'crsq_emailtags')
