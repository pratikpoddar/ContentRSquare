...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ArticleInfo', fields ['contenthash']
        db.create_unique(u'crsq_articleinfo', ['contenthash'])


    def backwards(self, orm):
        # Removing unique constraint on 'ArticleInfo', fields ['contenthash']
        db.delete_unique(u'crsq_articleinfo', ['contenthash'])
