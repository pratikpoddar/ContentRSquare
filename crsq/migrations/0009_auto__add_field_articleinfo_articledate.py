...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleInfo.articledate'
        db.add_column(u'crsq_articleinfo', 'articledate',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleInfo.articledate'
        db.delete_column(u'crsq_articleinfo', 'articledate')
