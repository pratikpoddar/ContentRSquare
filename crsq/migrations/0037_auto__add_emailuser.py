...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'crsq_emailuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255L)),
            ('email', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255L, db_index=True)),
            ('refreshtoken', self.gf('django.db.models.fields.TextField')()),
            ('accesstoken', self.gf('django.db.models.fields.TextField')()),
            ('lastid', self.gf('django.db.models.fields.TextField')()),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'crsq', ['EmailUser'])


    def backwards(self, orm):
        # Deleting model 'EmailUser'
        db.delete_table(u'crsq_emailuser')
