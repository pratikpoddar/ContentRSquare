...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EmailInfo.emailcc'
        db.delete_column(u'crsq_emailinfo', 'emailcc')

        # Deleting field 'EmailInfo.emailbcc'
        db.delete_column(u'crsq_emailinfo', 'emailbcc')

        # Adding field 'EmailInfo.emailccto'
        db.add_column(u'crsq_emailinfo', 'emailccto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255L),
                      keep_default=False)

        # Adding field 'EmailInfo.emailbccto'
        db.add_column(u'crsq_emailinfo', 'emailbccto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255L),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EmailInfo.emailcc'
        db.add_column(u'crsq_emailinfo', 'emailcc',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255L),
                      keep_default=False)

        # Adding field 'EmailInfo.emailbcc'
        db.add_column(u'crsq_emailinfo', 'emailbcc',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255L),
                      keep_default=False)

        # Deleting field 'EmailInfo.emailccto'
        db.delete_column(u'crsq_emailinfo', 'emailccto')

        # Deleting field 'EmailInfo.emailbccto'
        db.delete_column(u'crsq_emailinfo', 'emailbccto')
    ...
    models = {
        ...
        u'crsq.emailinfo': {
            ...
            'emailbccto': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255L'}),
            'emailccto': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255L'}),
