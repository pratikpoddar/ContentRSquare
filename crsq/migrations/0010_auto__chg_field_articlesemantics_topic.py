...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArticleSemantics.topic'
        db.alter_column(u'crsq_articlesemantics', 'topic', self.gf('django.db.models.fields.CharField')(max_length=1000L, null=True))

    def backwards(self, orm):

        # Changing field 'ArticleSemantics.topic'
        db.alter_column(u'crsq_articlesemantics', 'topic', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000L))
