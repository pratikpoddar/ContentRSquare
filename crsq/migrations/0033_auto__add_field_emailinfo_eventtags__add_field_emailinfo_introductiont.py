...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailInfo.eventtags'
        db.add_column(u'crsq_emailinfo', 'eventtags',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)

        # Adding field 'EmailInfo.introductiontags'
        db.add_column(u'crsq_emailinfo', 'introductiontags',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailInfo.eventtags'
        db.delete_column(u'crsq_emailinfo', 'eventtags')

        # Deleting field 'EmailInfo.introductiontags'
        db.delete_column(u'crsq_emailinfo', 'introductiontags')
