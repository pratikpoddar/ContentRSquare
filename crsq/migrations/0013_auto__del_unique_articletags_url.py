...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ArticleTags', fields ['url']
        db.delete_unique(u'crsq_articletags', ['url'])


    def backwards(self, orm):
        # Adding unique constraint on 'ArticleTags', fields ['url']
        db.create_unique(u'crsq_articletags', ['url'])
