...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleInfo.articlehtml'
        db.add_column(u'crsq_articleinfo', 'articlehtml',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleInfo.articlehtml'
        db.delete_column(u'crsq_articleinfo', 'articlehtml')
