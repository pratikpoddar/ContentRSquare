...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContentAffiliate.affiliate'
        db.alter_column(u'crsq_contentaffiliate', 'affiliate', self.gf('django.db.models.fields.CharField')(max_length=100L))

    def backwards(self, orm):

        # Changing field 'ContentAffiliate.affiliate'
        db.alter_column(u'crsq_contentaffiliate', 'affiliate', self.gf('picklefield.fields.PickledObjectField')())
    ...
    models = {
        ...
        u'crsq.contentaffiliate': {
            ...
            'affiliate': ('django.db.models.fields.CharField', [], {'max_length': '100L'}),
