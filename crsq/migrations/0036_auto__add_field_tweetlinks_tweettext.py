...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TweetLinks.tweettext'
        db.add_column(u'crsq_tweetlinks', 'tweettext',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000L, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TweetLinks.tweettext'
        db.delete_column(u'crsq_tweetlinks', 'tweettext')
