...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArticleInfo.articledate'
        db.alter_column(u'crsq_articleinfo', 'articledate', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'ArticleInfo.articledate'
        db.alter_column(u'crsq_articleinfo', 'articledate', self.gf('django.db.models.fields.DateTimeField')(null=True))
