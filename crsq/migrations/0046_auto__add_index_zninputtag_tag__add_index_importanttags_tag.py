...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ZnInputTag', fields ['tag']
        db.create_index(u'crsq_zninputtag', ['tag'])

        # Adding index on 'ImportantTags', fields ['tag']
        db.create_index(u'crsq_importanttags', ['tag'])


    def backwards(self, orm):
        # Removing index on 'ImportantTags', fields ['tag']
        db.delete_index(u'crsq_importanttags', ['tag'])

        # Removing index on 'ZnInputTag', fields ['tag']
        db.delete_index(u'crsq_zninputtag', ['tag'])
