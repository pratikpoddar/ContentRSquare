...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailInfo.efzpshortbody'
        db.add_column(u'crsq_emailinfo', 'efzpshortbody',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)

        # Adding field 'EmailInfo.efzpsignature'
        db.add_column(u'crsq_emailinfo', 'efzpsignature',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)

        # Adding field 'EmailInfo.places'
        db.add_column(u'crsq_emailinfo', 'places',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailInfo.efzpshortbody'
        db.delete_column(u'crsq_emailinfo', 'efzpshortbody')

        # Deleting field 'EmailInfo.efzpsignature'
        db.delete_column(u'crsq_emailinfo', 'efzpsignature')

        # Deleting field 'EmailInfo.places'
        db.delete_column(u'crsq_emailinfo', 'places')
