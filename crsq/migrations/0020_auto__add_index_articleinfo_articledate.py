...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ArticleInfo', fields ['articledate']
        db.create_index(u'crsq_articleinfo', ['articledate'])


    def backwards(self, orm):
        # Removing index on 'ArticleInfo', fields ['articledate']
        db.delete_index(u'crsq_articleinfo', ['articledate'])
