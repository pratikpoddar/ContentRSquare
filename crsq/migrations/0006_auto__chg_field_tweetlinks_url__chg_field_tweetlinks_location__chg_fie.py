...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TweetLinks.url'
        db.alter_column(u'crsq_tweetlinks', 'url', self.gf('django.db.models.fields.CharField')(max_length=255L))

        # Changing field 'TweetLinks.location'
        db.alter_column(u'crsq_tweetlinks', 'location', self.gf('django.db.models.fields.CharField')(max_length=500L, null=True))

        # Changing field 'ArticleInfo.url'
        db.alter_column(u'crsq_articleinfo', 'url', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255L))

        # Changing field 'ArticleInfo.articletitle'
        db.alter_column(u'crsq_articleinfo', 'articletitle', self.gf('django.db.models.fields.CharField')(max_length=1000L))

        # Changing field 'ArticleInfo.articleimage'
        db.alter_column(u'crsq_articleinfo', 'articleimage', self.gf('django.db.models.fields.TextField')(max_length=1000L))

    def backwards(self, orm):

        # Changing field 'TweetLinks.url'
        db.alter_column(u'crsq_tweetlinks', 'url', self.gf('django.db.models.fields.CharField')(max_length=100L))

        # Changing field 'TweetLinks.location'
        db.alter_column(u'crsq_tweetlinks', 'location', self.gf('django.db.models.fields.CharField')(max_length=100L, null=True))

        # Changing field 'ArticleInfo.url'
        db.alter_column(u'crsq_articleinfo', 'url', self.gf('django.db.models.fields.CharField')(max_length=100L, unique=True))

        # Changing field 'ArticleInfo.articletitle'
        db.alter_column(u'crsq_articleinfo', 'articletitle', self.gf('django.db.models.fields.CharField')(max_length=100L))

        # Changing field 'ArticleInfo.articleimage'
        db.alter_column(u'crsq_articleinfo', 'articleimage', self.gf('django.db.models.fields.TextField')(max_length=100L))
    ...
    models = {
        ...
        u'crsq.articleinfo': {
            ...
            'articleimage': ('django.db.models.fields.TextField', [], {'max_length': '1000L'}),
