...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing index on 'ArticleInfo', fields ['title']
        db.delete_index(u'crsq_articleinfo', ['title'])


    def backwards(self, orm):
        # Adding index on 'ArticleInfo', fields ['title']
        db.create_index(u'crsq_articleinfo', ['title'])
