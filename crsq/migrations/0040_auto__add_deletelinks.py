...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeleteLinks'
        db.create_table(u'crsq_deletelinks', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255L, db_index=True)),
            ('reason', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'crsq', ['DeleteLinks'])


    def backwards(self, orm):
        # Deleting model 'DeleteLinks'
        db.delete_table(u'crsq_deletelinks')
