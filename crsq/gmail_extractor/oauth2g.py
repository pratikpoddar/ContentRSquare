...
print ('OAuth2 argument:\n' +
        GenerateOAuth2String(user, response['access_token']))

imap_conn = imaplib.IMAP4_SSL('imap.gmail.com')
imap_conn.debug = 4
imap_conn.authenticate('XOAUTH2', lambda x: GenerateOAuth2String(user, response['access_token'],
                             base64_encode=False))
